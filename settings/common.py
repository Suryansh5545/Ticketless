"""
Django settings for ticketless project.
...
REST_AUTH = {
    'USE_JWT': True,
    'JWT_AUTH_COOKIE': 'ticketless-auth',
    'JWT_AUTH_REFRESH_COOKIE': 'ticketless-refresh-token',
}

WSGI_APPLICATION = 'ticketless.wsgi.application'
...
ticketless_API_SERVER = os.environ.get(
    "ticketless_API_SERVER", "http://localhost:8000"
)
